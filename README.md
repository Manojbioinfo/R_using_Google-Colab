...
- 🔹 **Notice:**  
  No warranties are provided. Other rights, such as privacy, publicity, or moral rights, may limit how you use the material.  

For full details, see the [CC BY-NC 4.0 license](https://creativecommons.org/licenses/by-nc/4.0/).

## ⚡ Contributions

Contributions are welcome! If you have suggestions, corrections, or improvements, please open a **pull request** or **issue**. All contributions follow the same CC BY-NC 4.0 license.  
